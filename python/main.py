...
player_images_right = {
    "normalR": pygame.image.load(resource_path('src/lib/persoD.png')),
    "cuttingR1": pygame.image.load(resource_path('src/lib/an_axeD.png')),
    "cuttingR2": pygame.image.load(resource_path('src/lib/cutD.png'))
}
player_images_left = {
    "normalL": pygame.image.load(resource_path('src/lib/perso.png')),
    "cuttingL1": pygame.image.load(resource_path('src/lib/an_axe.png')),
    "cuttingL2": pygame.image.load(resource_path('src/lib/cut.png'))
}
tree_image = pygame.image.load(resource_path('src/lib/buche.png'))
branch_image_right = pygame.image.load(resource_path('src/lib/branche.png'))
branch_image_left = pygame.image.load(resource_path('src/lib/brancheG.png'))
background_image = pygame.image.load(resource_path('src/lib/fond.png'))
overlay_image = pygame.image.load(resource_path('src/lib/plan.png'))
background_image_50 = pygame.image.load(resource_path('src/lib/fond7.png'))
overlay_image_50 = pygame.image.load(resource_path('src/lib/plan7.png'))
background_image_100 = pygame.image.load(resource_path('src/lib/fond2.png'))
overlay_image_100 = pygame.image.load(resource_path('src/lib/plan2.png'))
background_image_150 = pygame.image.load(resource_path('src/lib/fond3.png'))
overlay_image_150 = pygame.image.load(resource_path('src/lib/plan3.png'))
background_image_200 = pygame.image.load(resource_path('src/lib/fond6.png'))
overlay_image_200 = pygame.image.load(resource_path('src/lib/plan6.png'))

hit_sound = pygame.mixer.Sound(resource_path('src/sound/move.mp3'))

pygame.mixer.music.load(resource_path('src/sound/music.mp3'))
